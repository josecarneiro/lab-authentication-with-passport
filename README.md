...
In the repo you forked, there is a file called `private.hbs`. This page is referenced in the `passportRouter.js` with the path `/private-page`. We use the `route-guard-middleware` middleware to make sure that the user is logged in before viewing this page.
